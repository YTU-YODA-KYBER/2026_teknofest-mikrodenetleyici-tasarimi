...
//--------------------------------------------------
// Kullanılmayacak portlar için sıfır atıyoruz
//--------------------------------------------------
.interrupt_i(32'b0), // Interrupt sinyali için sıfır atıyoruz

.GPIO_IDR(32'b0), // GPIO IDR için sıfır atıyoruz
.GPIO_ODR(32'b0), // GPIO ODR çıkışını sıfır atıyoruz

.I2C_SCL(1'b0), // I2C SCL çıkışını sıfır atıyoruz

.QSPI_SCLK(1'b0), // QSPI SCLK çıkışını sıfır atıyoruz
.QSPI_CS(1'b0) // QSPI CS çıkışını sıfır atıyoruz
