 ...
 *      SYS_CLK_HZ'de (50 MHz) adim basina ~STEP_MS milisaniye hedeflenir.
 * ===================================================================== */
...
/* 50 MHz'de ~ (50000 cevrim/ms) / (~8 cevrim/dongu) ~= 6250.
...
#else
#define LOOPS_PER_MS   6250u    /* gercek donanim: ~90 ms/adim @ 50 MHz */
#endif
