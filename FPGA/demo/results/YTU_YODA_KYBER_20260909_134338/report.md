...
- Tarih: 2026-09-09T13:43:51+03:00
- Harness surumu: 1.0.1
- Konfigurasyon kaynagi: `/home/luxyxp/Documents/mainfiles/FPGA/demo/ytu_yoda_kyber_icd.json`
- Etkin konfigurasyon: `config_used.json` (SHA256 `82d10e7cf23150a3`)
- Veri seti: public_dataset/manifest.csv | seed: 1337
- Arayuzler: stream `/dev/serial/by-id/usb-FTDI_FT232R_USB_UART_AU05XH47-if00-port0@1000000`, core `/dev/serial/by-id/usb-Digilent_Digilent_USB_Device_210292BF69A9-if01-port0@115200`
...
| Gecikme (medyan / p95 / max) | 4.45 / 5.61 / 6.63 ms |
| Olculen hizlanma (yazilim / donanim) | 56.7x |
...
|---|---|---|
| silence_zeros | PASS | cikti=no, gecikme=4.2 ms, sonraki gecerli cerceve yanitladi |
| silence_dither | PASS | cikti=no, gecikme=2.9 ms, sonraki gecerli cerceve yanitladi |
| saturate_max | PASS | cikti=unknown, gecikme=4.1 ms, sonraki gecerli cerceve yanitladi |
| saturate_min | PASS | cikti=silence, gecikme=4.1 ms, sonraki gecerli cerceve yanitladi |
| alternating | PASS | cikti=silence, gecikme=4.2 ms, sonraki gecerli cerceve yanitladi |
...
| determinism | PASS | 10 tekrarda 1 farkli sonuc; gecikme jitter=1.88 ms |
