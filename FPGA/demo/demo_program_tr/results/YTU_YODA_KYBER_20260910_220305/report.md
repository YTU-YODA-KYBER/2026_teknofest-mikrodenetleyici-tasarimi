...
| Gecikme (medyan / p95 / max) | 5.26 / 6.88 / 7.02 ms |
| Olculen hizlanma (yazilim / donanim) | 48.0x |
...
|---|---|---|
| silence_zeros | PASS | cikti=no, gecikme=5.3 ms, sonraki gecerli cerceve yanitladi |
| silence_dither | PASS | cikti=no, gecikme=5.2 ms, sonraki gecerli cerceve yanitladi |
| saturate_max | PASS | cikti=unknown, gecikme=7.0 ms, sonraki gecerli cerceve yanitladi |
| saturate_min | PASS | cikti=silence, gecikme=5.1 ms, sonraki gecerli cerceve yanitladi |
| alternating | PASS | cikti=silence, gecikme=5.1 ms, sonraki gecerli cerceve yanitladi |
...
| determinism | PASS | 10 tekrarda 1 farkli sonuc; gecikme jitter=1.32 ms |
