...
- Tarih: 2026-09-10T22:03:55+03:00
...
| Gecikme (medyan / p95 / max) | 3.07 / 4.66 / 4.83 ms |
| Olculen hizlanma (yazilim / donanim) | 82.3x |
...
|---|---|---|
| silence_zeros | PASS | cikti=no, gecikme=3.0 ms, sonraki gecerli cerceve yanitladi |
| silence_dither | PASS | cikti=no, gecikme=2.9 ms, sonraki gecerli cerceve yanitladi |
| saturate_max | PASS | cikti=unknown, gecikme=3.0 ms, sonraki gecerli cerceve yanitladi |
| saturate_min | PASS | cikti=silence, gecikme=2.9 ms, sonraki gecerli cerceve yanitladi |
| alternating | PASS | cikti=silence, gecikme=3.0 ms, sonraki gecerli cerceve yanitladi |
...
| determinism | PASS | 10 tekrarda 1 farkli sonuc; gecikme jitter=1.94 ms |
