...
| Gecikme (medyan / p95 / max) | 3.24 / 4.82 / 5.09 ms |
| Olculen hizlanma (yazilim / donanim) | 77.9x |
...
|---|---|---|
| silence_zeros | PASS | cikti=no, gecikme=3.1 ms, sonraki gecerli cerceve yanitladi |
| silence_dither | PASS | cikti=no, gecikme=4.6 ms, sonraki gecerli cerceve yanitladi |
| saturate_max | PASS | cikti=unknown, gecikme=3.1 ms, sonraki gecerli cerceve yanitladi |
| saturate_min | PASS | cikti=silence, gecikme=3.0 ms, sonraki gecerli cerceve yanitladi |
| alternating | PASS | cikti=silence, gecikme=3.1 ms, sonraki gecerli cerceve yanitladi |
...
| determinism | PASS | 10 tekrarda 1 farkli sonuc; gecikme jitter=1.85 ms |
