...
- Tarih: 2026-09-10T22:01:51+03:00
...
| Gecikme (medyan / p95 / max) | 8.30 / 9.32 / 9.57 ms |
| Olculen hizlanma (yazilim / donanim) | 30.4x |
...
|---|---|---|
| silence_zeros | PASS | cikti=no, gecikme=8.1 ms, sonraki gecerli cerceve yanitladi |
| silence_dither | PASS | cikti=no, gecikme=8.0 ms, sonraki gecerli cerceve yanitladi |
| saturate_max | PASS | cikti=unknown, gecikme=9.0 ms, sonraki gecerli cerceve yanitladi |
| saturate_min | PASS | cikti=silence, gecikme=9.1 ms, sonraki gecerli cerceve yanitladi |
| alternating | PASS | cikti=silence, gecikme=9.0 ms, sonraki gecerli cerceve yanitladi |
...
| determinism | PASS | 10 tekrarda 1 farkli sonuc; gecikme jitter=1.15 ms |
