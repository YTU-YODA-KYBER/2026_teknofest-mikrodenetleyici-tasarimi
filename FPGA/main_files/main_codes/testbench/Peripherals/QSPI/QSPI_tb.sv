...
module QSPI_Master_tb;
    ...
    //   uzerinde SIFIR GENISLIKLI darbe (0->1->0, ayni t aninda) uretiyordu:
    //   DUT'un always blogu ayni aktif bolgede darbeyi yakalayip islemi kabul
    //   ediyor, ancak bind edilmis protokol kontrolcusunun sayac mantigi
    //   (wire aw_hs / ar_hs) darbeyi goremiyordu. Sonucta kontrolcunun
    //   sayaclari DUT ile ayrisiyor ve OUT_01/OUT_02 simulasyonun sonuna
    //   kadar her cevrimde ihlal veriyordu (600 binden fazla sahte ihlal).
    ...
    // Ucusta kalan son AXI islemlerinin (B/R cevaplari) tamamlanmasi icin
    // kisa bir bosaltma; yoksa FIN_01/FIN_02 "cevapsiz islem" bilgisi basar.
