module AXI4_Interconnect #(
    ...
    // ==============================================================================
    // MASTER 4: UART (GENEL KULLANIM) PORTLARI (AXI4-Lite) - Base: 0x4004_0000
    // ==============================================================================
    ...
    // ==============================================================================
    // MASTER 5: UART (YZ HIZLANDIRICI) PORTLARI (AXI4-Lite) - Base: 0x4005_0000
    // ==============================================================================
    ...
    // ==============================================================
    output logic [31:0] axi_m7_awaddr,
    output logic        axi_m7_awvalid,
    input  logic        axi_m7_awready,
    output logic [31:0] axi_m7_wdata,
    output logic [ 3:0] axi_m7_wstrb,
    output logic        axi_m7_wvalid,
    input  logic        axi_m7_wready,
    input  logic [ 1:0] axi_m7_bresp,
    input  logic        axi_m7_bvalid,
    output logic        axi_m7_bready,
    ...
    // ==============================================================
    // MASTER 8: INSTRUCTION RAM PORTLARI (AXI4-Lite) - Base: 0x1000_0000
    // ==============================================================
    output logic [31:0] axi_m8_awaddr,
    output logic        axi_m8_awvalid,
    input  logic        axi_m8_awready,
    output logic [31:0] axi_m8_wdata,
    output logic [ 3:0] axi_m8_wstrb,
    output logic        axi_m8_wvalid,
    input  logic        axi_m8_wready,
    input  logic [ 1:0] axi_m8_bresp,
    input  logic        axi_m8_bvalid,
    output logic        axi_m8_bready,
    output logic [31:0] axi_m8_araddr,
    output logic        axi_m8_arvalid,
    input  logic        axi_m8_arready,
    input  logic [31:0] axi_m8_rdata,
    input  logic [ 1:0] axi_m8_rresp,
    input  logic        axi_m8_rvalid,
    output logic        axi_m8_rready,


    // ==============================================================
    // MASTER 9: BOOT RAM PORTLARI (AXI4-Lite) - Base: 0x0000_0000
    // ==============================================================
    output logic [31:0] axi_m9_araddr,
    output logic        axi_m9_arvalid,
    input  logic        axi_m9_arready,
    input  logic [31:0] axi_m9_rdata,
    input  logic [ 1:0] axi_m9_rresp,
    input  logic        axi_m9_rvalid,
    output logic        axi_m9_rready


);

    assign axi_m7_wstrb = axi_s0_wstrb;
    assign axi_m8_wstrb = axi_s0_wstrb;

    // ==============================================================
    // 1. ADRES ÇÖZÜCÜ (Address Decoder)
    // ==============================================================
    logic sel_timer_aw, sel_gpio_aw, sel_i2c_aw, sel_qspi_aw, sel_uartgu_aw, sel_uartyz_aw, sel_yz_aw, sel_dataram_aw, sel_instrram_aw;
    logic sel_timer_ar, sel_gpio_ar, sel_i2c_ar, sel_qspi_ar, sel_uartgu_ar, sel_uartyz_ar, sel_yz_ar, sel_dataram_ar , sel_instrram_ar, sel_bootram_ar;
    ...
    assign sel_uartgu_aw   = (axi_s0_awaddr >= 32'h4004_0000) && (axi_s0_awaddr < 32'h4005_0000);
    assign sel_uartyz_aw   = (axi_s0_awaddr >= 32'h4005_0000) && (axi_s0_awaddr < 32'h4006_0000);
    assign sel_yz_aw       = (axi_s0_awaddr >= 32'h4006_0000) && (axi_s0_awaddr < 32'h4007_0000);
    ...
    assign sel_uartgu_ar   = (axi_s0_araddr >= 32'h4004_0000) && (axi_s0_araddr < 32'h4005_0000);
    assign sel_uartyz_ar   = (axi_s0_araddr >= 32'h4005_0000) && (axi_s0_araddr < 32'h4006_0000);
    assign sel_yz_ar       = (axi_s0_araddr >= 32'h4006_0000) && (axi_s0_araddr < 32'h4007_0000);
    ...
    assign sel_none_aw = ~(sel_timer_aw | sel_gpio_aw | sel_i2c_aw |
                        sel_qspi_aw  | sel_uartgu_aw | sel_uartyz_aw | sel_yz_aw | sel_dataram_aw | sel_instrram_aw);
    assign sel_none_ar = ~(sel_timer_ar | sel_gpio_ar | sel_i2c_ar |
                        sel_qspi_ar  | sel_uartgu_ar | sel_uartyz_ar | sel_yz_ar | sel_dataram_ar | sel_instrram_ar | sel_bootram_ar);
    ...
    assign axi_m7_awaddr = axi_s0_awaddr;
    assign axi_m8_awaddr = axi_s0_awaddr;
    ...
    assign axi_m7_wdata  = axi_s0_wdata;
    assign axi_m8_wdata  = axi_s0_wdata;
    ...
    assign axi_m7_bready = axi_s0_bready;
    assign axi_m8_bready = axi_s0_bready;
    ...
    assign axi_m4_awvalid = axi_s0_awvalid & sel_uartgu_aw;
    assign axi_m5_awvalid = axi_s0_awvalid & sel_uartyz_aw;
    assign axi_m6_awvalid = axi_s0_awvalid & sel_yz_aw;
    assign axi_m7_awvalid = axi_s0_awvalid & sel_dataram_aw;
    assign axi_m8_awvalid = axi_s0_awvalid & sel_instrram_aw;
    ...
    assign axi_m4_wvalid  = axi_s0_wvalid & sel_uartgu_aw;
    assign axi_m5_wvalid  = axi_s0_wvalid & sel_uartyz_aw;
    assign axi_m6_wvalid  = axi_s0_wvalid & sel_yz_aw;
    assign axi_m7_wvalid  = axi_s0_wvalid & sel_dataram_aw;
    assign axi_m8_wvalid  = axi_s0_wvalid & sel_instrram_aw;
    ...
    assign axi_s0_awready = sel_timer_aw    ? axi_m0_awready :
                            ...
                            sel_uartgu_aw   ? axi_m4_awready :
                            sel_uartyz_aw   ? axi_m5_awready :
                            sel_yz_aw       ? axi_m6_awready :
                            sel_dataram_aw  ? axi_m7_awready :
                            sel_instrram_aw ? axi_m8_awready : decerr_awready_w;
    ...
    assign axi_s0_wready  = sel_timer_aw    ? axi_m0_wready :
                            ...
                            sel_uartgu_aw   ? axi_m4_wready :
                            sel_uartyz_aw   ? axi_m5_wready :
                            sel_yz_aw       ? axi_m6_wready :
                            sel_dataram_aw  ? axi_m7_wready :
                            sel_instrram_aw ? axi_m8_wready : decerr_wready_w;

    // Cevap (B) kanalı sadece aktif modülden alınır
    assign axi_s0_bvalid  = axi_m0_bvalid | axi_m1_bvalid | axi_m2_bvalid | axi_m3_bvalid | axi_m4_bvalid | axi_m5_bvalid | axi_m6_bvalid | axi_m7_bvalid | axi_m8_bvalid | decerr_bvalid;
    ...
    assign axi_s0_bresp   = axi_m0_bvalid ? axi_m0_bresp :
                            ...
                            axi_m7_bvalid ? axi_m7_bresp :
                            axi_m8_bvalid ? axi_m8_bresp :
    ...
    assign axi_m8_araddr = axi_s0_araddr;
    assign axi_m9_araddr = axi_s0_araddr;
    ...
    assign axi_m8_rready = axi_s0_rready;
    assign axi_m9_rready = axi_s0_rready;
    ...
    assign axi_m4_arvalid = axi_s0_arvalid & sel_uartgu_ar;
    assign axi_m5_arvalid = axi_s0_arvalid & sel_uartyz_ar;
    assign axi_m6_arvalid = axi_s0_arvalid & sel_yz_ar;
    assign axi_m7_arvalid = axi_s0_arvalid & sel_dataram_ar;
    assign axi_m8_arvalid = axi_s0_arvalid & sel_instrram_ar;
    assign axi_m9_arvalid = axi_s0_arvalid & sel_bootram_ar;
    ...
    assign axi_s0_arready = sel_timer_ar    ? axi_m0_arready :
                            ...
                            sel_uartgu_ar   ? axi_m4_arready :
                            sel_uartyz_ar   ? axi_m5_arready :
                            sel_yz_ar       ? axi_m6_arready :
                            sel_dataram_ar  ? axi_m7_arready :
                            sel_instrram_ar ? axi_m8_arready :
                            sel_bootram_ar  ? axi_m9_arready : decerr_arready_r;

    // Okuma Cevabı (R) toplanıp işlemciye aktarılır
    assign axi_s0_rvalid  = axi_m0_rvalid | axi_m1_rvalid | axi_m2_rvalid | axi_m3_rvalid | axi_m4_rvalid | axi_m5_rvalid | axi_m6_rvalid | axi_m7_rvalid | axi_m8_rvalid | axi_m9_rvalid | decerr_rvalid;
    ...
    assign axi_s0_rdata   = axi_m0_rvalid ? axi_m0_rdata :
                            ...
                            axi_m7_rvalid ? axi_m7_rdata :
                            axi_m8_rvalid ? axi_m8_rdata :
                            axi_m9_rvalid ? axi_m9_rdata : decerr_rvalid  ? 32'h0 : 32'h0;
    ...
    assign axi_s0_rresp   = axi_m0_rvalid ? axi_m0_rresp :
                            ...
                            axi_m7_rvalid ? axi_m7_rresp :
                            axi_m8_rvalid ? axi_m8_rresp :
                            axi_m9_rvalid ? axi_m9_rresp : decerr_rvalid  ? 2'b10 : 2'b00;;
