create_project -force UART_YZ_Module ./Vivado_projects/UART_YZ_Module -part xc7a35tcpg236-1
...
add_files ./main_codes/testbench/AXI_protocol_check/Bind_for_peripherals/axi4lite_bind_uart_yz.svh -fileset sim_1
add_files ./main_codes/testbench/AXI_protocol_check/axi4lite_protocol_checker.sv -fileset sim_1
set_property file_type "Verilog Header" [get_files *axi4lite_bind_uart_yz.svh]
