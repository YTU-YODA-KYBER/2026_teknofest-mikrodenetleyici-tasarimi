create_project -force boot_system_test ./Vivado_projects/boot_system_test -part xc7a100tcsg324-1
...
add_files ./main_codes/testbench/System_Test/boot_test.sv -fileset sim_1
...
add_files ./firmware/makefile_outputs/sim_boot.hex
set_property file_type "Memory File" [get_files ./firmware/makefile_outputs/sim_boot.hex]
...
set_property top boot_test [get_filesets sim_1]
