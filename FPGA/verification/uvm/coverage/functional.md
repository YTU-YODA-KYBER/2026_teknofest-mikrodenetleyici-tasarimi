...
|---|---|---:|---|
| `cp_kind` | `okuma` | 6197 | dolu |
| `cp_kind` | `yazma` | 3559 | dolu |
| `cp_offset` | `ofs_00` | 1680 | dolu |
| `cp_offset` | `ofs_04` | 2343 | dolu |
| `cp_offset` | `ofs_08` | 787 | dolu |
| `cp_offset` | `ofs_0C` | 1826 | dolu |
| `cp_offset` | `ofs_10` | 2587 | dolu |
| `cp_offset` | `ofs_14` | 305 | dolu |
| `cp_offset` | `ofs_18` | 92 | dolu |
| `cp_offset` | `ofs_1C` | 73 | dolu |
| `cp_offset` | `haritasiz` | 63 | dolu |
| `cp_resp` | `okay` | 9756 | dolu |
| `cp_resp` | `slverr` | 0 | **erisilemez** (gerekce asagida) |
| `cp_resp` | `decerr` | 0 | **erisilemez** (gerekce asagida) |
| `cp_gap` | `bitisik` | 126 | dolu |
| `cp_gap` | `kisa` | 5319 | dolu |
| `cp_gap` | `orta` | 1116 | dolu |
| `cp_gap` | `uzun` | 1629 | dolu |
| `cp_wdata` | `sifir` | 6452 | dolu |
| `cp_wdata` | `tumbir` | 72 | dolu |
| `cp_wdata` | `digeri` | 3232 | dolu |
| `x_kind_offset` | `okuma_x_ofs_00` | 873 | dolu |
| `x_kind_offset` | `okuma_x_ofs_04` | 1271 | dolu |
| `x_kind_offset` | `okuma_x_ofs_08` | 532 | dolu |
| `x_kind_offset` | `okuma_x_ofs_0C` | 1075 | dolu |
| `x_kind_offset` | `okuma_x_ofs_10` | 2085 | dolu |
| `x_kind_offset` | `okuma_x_ofs_14` | 187 | dolu |
| `x_kind_offset` | `okuma_x_ofs_18` | 80 | dolu |
| `x_kind_offset` | `okuma_x_ofs_1C` | 52 | dolu |
| `x_kind_offset` | `yazma_x_ofs_00` | 807 | dolu |
| `x_kind_offset` | `yazma_x_ofs_04` | 1072 | dolu |
| `x_kind_offset` | `yazma_x_ofs_08` | 255 | dolu |
| `x_kind_offset` | `yazma_x_ofs_0C` | 751 | dolu |
| `x_kind_offset` | `yazma_x_ofs_10` | 502 | dolu |
