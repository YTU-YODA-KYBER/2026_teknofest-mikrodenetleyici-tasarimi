...
## ---- QSPI → PMOD JB ----
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports QSPI_CS]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports QSPI_IO0]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports QSPI_IO1]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports QSPI_SCLK]
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports QSPI_IO2]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports QSPI_IO3]

## Harici cihaza reset çıkışı (Pmod JB8)
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33} [get_ports sys_rst_out]
...
## bitstream dosyasını karttaki flash memory'e yazmak için
