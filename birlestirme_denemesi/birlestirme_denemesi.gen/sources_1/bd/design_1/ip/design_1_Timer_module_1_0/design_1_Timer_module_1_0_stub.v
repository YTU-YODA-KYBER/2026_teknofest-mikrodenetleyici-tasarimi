...
// Command     : write_verilog -force -mode synth_stub -rename_top design_1_Timer_module_1_0 -prefix
//               design_1_Timer_module_1_0_ design_1_Timer_module_0_0_stub.v
...
module design_1_Timer_module_1_0(clk_i, rst_n, awaddr, awvalid, awready, wdata, 
  wvalid, wready, bresp, bvalid, bready, araddr, arvalid, arready, rready, rdata, rresp, rvalid)
/* synthesis syn_black_box black_box_pad_pin="rst_n,awaddr[31:0],awvalid,awready,wdata[31:0],wvalid,wready,bresp[1:0],bvalid,bready,araddr[31:0],arvalid,arready,rready,rdata[31:0],rresp[1:0],rvalid" */
/* synthesis syn_force_seq_prim="clk_i" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF interface_aximm, FREQ_TOLERANCE_HZ 0, FREQ_HZ 50000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0" *) input clk_i /* synthesis syn_isclock = 1 */;
