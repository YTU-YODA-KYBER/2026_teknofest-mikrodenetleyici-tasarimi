...
HD_PWD='C:/Users/deniz/Documents/TEKNOFEST_Modules/birlestirme_denemesi/birlestirme_denemesi.runs/design_1_Timer_module_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Timer_module_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Timer_module_0_0.tcl
