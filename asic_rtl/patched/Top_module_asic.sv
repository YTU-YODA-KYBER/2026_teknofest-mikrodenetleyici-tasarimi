...
//  SHA256 : fc2867a39d2cf0086265006ecfe389266a360e1317da810833069ef5a4235e0b
//
...
module top_module #(
    ...
    // NOT: Bu degerler sartnamenin bellek sinirlarina gore secilmistir ve
    // ANA PROJEDE degistirilmez. YZ bench senaryosu (yazilim gerceklemesini
    // CPU'da kosturma) 32KB'a ihtiyac duyar; orada bu parametreler
    // yz_bench_test.tcl / yz_bench_test.sv tarafindan DISARIDAN ezilir,
    ...
    // AW Portları
    logic [31:0] UART_GU_awaddr;
    logic        UART_GU_awvalid;
    logic        UART_GU_awready;
    // W Portları
    logic [31:0] UART_GU_wdata;
    logic        UART_GU_wvalid;
    logic        UART_GU_wready;
    // B Portları
    logic [ 1:0] UART_GU_bresp;
    logic        UART_GU_bvalid;
    logic        UART_GU_bready;
    // AR Portları
    logic [31:0] UART_GU_araddr;
    logic        UART_GU_arvalid;
    logic        UART_GU_arready;
    // R Portları
    logic        UART_GU_rready;
    logic [31:0] UART_GU_rdata;
    logic [ 1:0] UART_GU_rresp;
    logic        UART_GU_rvalid;


    // AW Portları
    logic [31:0] UART_YZ_awaddr;
    logic        UART_YZ_awvalid;
    logic        UART_YZ_awready;
    // W Portları
    logic [31:0] UART_YZ_wdata;
    logic        UART_YZ_wvalid;
    logic        UART_YZ_wready;
    // B Portları
    logic [ 1:0] UART_YZ_bresp;
    logic        UART_YZ_bvalid;
    logic        UART_YZ_bready;
    // AR Portları
    logic [31:0] UART_YZ_araddr;
    logic        UART_YZ_arvalid;
    logic        UART_YZ_arready;
    // R Portları
    logic        UART_YZ_rready;
    logic [31:0] UART_YZ_rdata;
    logic [ 1:0] UART_YZ_rresp;
    logic        UART_YZ_rvalid;
    ...
    logic [ 3:0] axi_instr_bram_wstrb;
    ...
    logic [ADDR_WIDTH_yz-1:0] yz_bram_raddr;
    ...
    assign cpu_instr_awready = 1'b0;
    assign cpu_instr_wready  = 1'b0;
    assign cpu_instr_bvalid  = 1'b0;
    assign cpu_instr_bresp   = 2'b00;

conv_accelerator #(
    .RAM_ADDR_W(ADDR_WIDTH_yz)
) conv_accelerator_inst (
    .clk(clk_i),
    .rst_n(rst_sys_ni),
    .start(acc_start),
    .done (acc_done),
...
instr_bram_axi_ctrl #(
    ...
    .axi_instr_bram_wstrb  (axi_instr_bram_wstrb),
...
data_bram_axi_ctrl #(
    ...
    .axi_data_bram_wstrb  (axi_data_bram_wstrb),
...
AXI4_Interconnect interconnect_inst(
    ...
    // ==============================================================
    .axi_m4_awaddr (UART_GU_awaddr),
    .axi_m4_awvalid(UART_GU_awvalid),
    .axi_m4_awready(UART_GU_awready),
    .axi_m4_wdata  (UART_GU_wdata),
    .axi_m4_wvalid (UART_GU_wvalid),
    .axi_m4_wready (UART_GU_wready),
    .axi_m4_bresp  (UART_GU_bresp),
    .axi_m4_bvalid (UART_GU_bvalid),
    .axi_m4_bready (UART_GU_bready),
    .axi_m4_araddr (UART_GU_araddr),
    .axi_m4_arvalid(UART_GU_arvalid),
    .axi_m4_arready(UART_GU_arready),
    .axi_m4_rdata  (UART_GU_rdata),
    .axi_m4_rresp  (UART_GU_rresp),
    .axi_m4_rvalid (UART_GU_rvalid),
    .axi_m4_rready (UART_GU_rready),

    // ==============================================================================
    // MASTER 5: UART (YZ HIZLANDIRICI) PORTLARI (AXI4-Lite) - Base: 0x4005_0000
    // ==============================================================================
    .axi_m5_awaddr (UART_YZ_awaddr),
    .axi_m5_awvalid(UART_YZ_awvalid),
    .axi_m5_awready(UART_YZ_awready),
    .axi_m5_wdata  (UART_YZ_wdata),
    .axi_m5_wvalid (UART_YZ_wvalid),
    .axi_m5_wready (UART_YZ_wready),
    .axi_m5_bresp  (UART_YZ_bresp),
    .axi_m5_bvalid (UART_YZ_bvalid),
    .axi_m5_bready (UART_YZ_bready),
    .axi_m5_araddr (UART_YZ_araddr),
    .axi_m5_arvalid(UART_YZ_arvalid),
    .axi_m5_arready(UART_YZ_arready),
    .axi_m5_rdata  (UART_YZ_rdata),
    .axi_m5_rresp  (UART_YZ_rresp),
    .axi_m5_rvalid (UART_YZ_rvalid),
    .axi_m5_rready (UART_YZ_rready),
    ...
    // ==============================================================
    .axi_m7_awaddr (axi_data_bram_awaddr),
    .axi_m7_awvalid(axi_data_bram_awvalid),
    .axi_m7_awready(axi_data_bram_awready),
    .axi_m7_wdata  (axi_data_bram_wdata),
    .axi_m7_wstrb  (axi_data_bram_wstrb),
    .axi_m7_wvalid (axi_data_bram_wvalid),
    .axi_m7_wready (axi_data_bram_wready),
    .axi_m7_bresp  (axi_data_bram_bresp),
    .axi_m7_bvalid (axi_data_bram_bvalid),
    .axi_m7_bready (axi_data_bram_bready),
    .axi_m7_araddr (axi_data_bram_araddr),
    .axi_m7_arvalid(axi_data_bram_arvalid),
    .axi_m7_arready(axi_data_bram_arready),
    .axi_m7_rdata  (axi_data_bram_rdata),
    .axi_m7_rresp  (axi_data_bram_rresp),
    .axi_m7_rvalid (axi_data_bram_rvalid),
    .axi_m7_rready (axi_data_bram_rready),

    // ==============================================================
    // MASTER 8: INSTRUCTION RAM PORTLARI (AXI4-Lite) - Base: 0x0000_0000
    // ==============================================================
    .axi_m8_awaddr (axi_instr_bram_awaddr),
    .axi_m8_awvalid(axi_instr_bram_awvalid),
    .axi_m8_awready(axi_instr_bram_awready),
    .axi_m8_wdata  (axi_instr_bram_wdata),
    .axi_m8_wstrb  (axi_instr_bram_wstrb),
    .axi_m8_wvalid (axi_instr_bram_wvalid),
    .axi_m8_wready (axi_instr_bram_wready),
    ...
    // ==============================================================
    .axi_m9_araddr (axi_boot_rom_interconnect_araddr),
    .axi_m9_arvalid(axi_boot_rom_interconnect_arvalid),
    .axi_m9_arready(axi_boot_rom_interconnect_arready),
    .axi_m9_rdata  (axi_boot_rom_interconnect_rdata),
    .axi_m9_rresp  (axi_boot_rom_interconnect_rresp),
    .axi_m9_rvalid (axi_boot_rom_interconnect_rvalid),
    .axi_m9_rready (axi_boot_rom_interconnect_rready)
...
UART_GU_AXI4_Lite uart_gu_inst(
    ...
    .awaddr (UART_GU_awaddr),
    .awvalid(UART_GU_awvalid),
    .awready(UART_GU_awready),
    .wdata  (UART_GU_wdata),
    .wvalid (UART_GU_wvalid),
    .wready (UART_GU_wready),
    .bresp  (UART_GU_bresp),
    .bvalid (UART_GU_bvalid),
    .bready (UART_GU_bready),
    .araddr (UART_GU_araddr),
    .arvalid(UART_GU_arvalid),
    .arready(UART_GU_arready),
    .rready (UART_GU_rready),
    .rdata  (UART_GU_rdata),
    .rresp  (UART_GU_rresp),
    .rvalid (UART_GU_rvalid),
...
UART_YZ_AXI4_Lite uart_yz_inst(
    ...
    .awaddr (UART_YZ_awaddr),
    .awvalid(UART_YZ_awvalid),
    .awready(UART_YZ_awready),
    .wdata  (UART_YZ_wdata),
    .wvalid (UART_YZ_wvalid),
    .wready (UART_YZ_wready),
    .bresp  (UART_YZ_bresp),
    .bvalid (UART_YZ_bvalid),
    .bready (UART_YZ_bready),
    .araddr (UART_YZ_araddr),
    .arvalid(UART_YZ_arvalid),
    .arready(UART_YZ_arready),
    .rready (UART_YZ_rready),
    .rdata  (UART_YZ_rdata),
    .rresp  (UART_YZ_rresp),
...
I2C_Master_AXI4_Lite #(.CLK_FREQ_HZ(28000000)) i2c_master_inst(
    .clk_i(clk_i),
    .rst_n(rst_sys_ni),
...
Instr_Splitter instr_splitter_inst(
    // ==========================
    //  GİRİŞ PORTLARI
    // ==========================
